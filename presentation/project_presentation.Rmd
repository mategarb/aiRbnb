...
author: "Tatiana Belova</br>Mateusz Garbulowski</br>Beate Salberg</br>Karolina Smolinska"
...
- Boxplots of statistical test for prices in 2 regions
...
library(knitr)
library(kableExtra)
names2 <- c("replications","elapsed","relative","user.self","sys.self")
after <- c(2, 36.213, 1.000, 33.249, 1.050)
before <- c(2, 454.004, 12.537, 430.026, 7.932)
...
library(knitr)
library(kableExtra)
names3 <- c("replications","elapsed","relative","user.self","sys.self")
generate_map <- c(2, 0.046, 5.1, 0.043, 0.002)
remove_outs <- c(2, 0.009, 1.0, 0.004, 0.002)
wilcox_test <- c(2, 0.073, 8.1, 0.072, 0.001)
