...
colfunc <- colorRampPalette(c("coral", "darkorchid"))
wordcloud(words = words_inp$words_inp_word, freq = words_inp$Freq, min.freq = 2,
          max.words=top_words, random.order=F, colors=colfunc(10), scale = c(1.2, 0.5))
